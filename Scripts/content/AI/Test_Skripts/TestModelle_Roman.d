...
instance ItMw1hSwordBurning(C_Item)
{
	...
	text[0]						= "";											count[0] = 0;
	text[1]						= "This is a fucking good sword for";			count[1] = 0;
	text[2]						= "killing all fucking creatures who";			count[2] = 0;
	text[3]						= "trying to fuck with you!";					count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= "Damage";										count[5] = DAMAGETOTAL;
};
...
instance ItMw2hSwordBurning(C_Item)
{
	...
	text[0]						= "";											count[0] = 0;
	text[1]						= "Nothing restists the burning touch";			count[1] = 0;
	text[2]						= "of this legendary shword that was";			count[2] = 0;
	text[3]						= "already believe to be lost forever";			count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= "Damage";										count[5] = DAMAGETOTAL;
};
...
instance ItRwWarBowBurning(C_Item)
{
	...
	text[0]						= "";											count[0] = 0;
	text[1]						= "Carved in the ancient times before";			count[1] = 0;
	text[2]						= "the creation of mankind, this bow is";		count[2] = 0;
	text[3]						= "the mightiest ranged weapon ever";			count[3] = 0;
	text[4]						= "";											count[4] = 0;
	text[5]						= "Damage";										count[5] = DAMAGETOTAL;
};
