	...
	if ((TAL_Wert + 1) == NEW_Wert)
	{
		if (typ.lp >= LP_cost)
		{
			...
			if (tal == NPC_TALENT_1H)
			{
				...
				PrintScreen(PRINT_LEARN_Onehanded, -1, -1, "FONT_OLD_20_WHITE.TGA", 2);
				return 1;
			}
			else if (tal == NPC_TALENT_2H)
			{
				...
				PrintScreen(PRINT_LEARN_Twohanded, -1, -1, "FONT_OLD_20_WHITE.TGA", 2);
				return 1;
			}
			else if (tal == NPC_TALENT_BOW)
			{
				...
				PrintScreen(PRINT_LEARN_Bow, -1, -1, "FONT_OLD_20_WHITE.TGA", 2);
				return 1;
			}
			else if (tal == NPC_TALENT_CROSSBOW)
			{
				...
				PrintScreen(PRINT_LEARN_Crossbow, -1, -1, "FONT_OLD_20_WHITE.TGA", 2);
				return 1;
			}
			else if (tal == NPC_TALENT_PICKLOCK)
			{
				...
				PrintScreen(PRINT_LEARN_Locks, -1, -1, "FONT_OLD_20_WHITE.TGA", 2);
				return 1;
			}
