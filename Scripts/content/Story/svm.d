...
// "var string xxxx" erweitert werden, diese kï¿½nnen dann in den
// einzelnen SVM - Instanzen initialisiert werden.

class C_SVM
{
// SC hat Waffe oder Magie gezogen oder zielt auf NSC
	var string StopMagic;																		// NSC  sieht wie in seiner Nï¿½he gezaubert wird -> er fordert auf, damit aufzuhï¿½ren!
	...
	var string WeaponDown;																		// ZS_AssessFighter: SC steht mit gezogener Waffe vor NSC -> NSC ist NEUTRAL zu SC	-> (herausfordernd,	bei	Pï¿½nten-Stimme etwas	unsicher, trotzdem kernig)
	var string ISaidWeaponDown;																	// Kommt nachdem der SC $WeaponDown ignoriert hat!

	var string WatchYourAim;																	// ein FRIENDLY-SC zielt mit einer Fernkampfwaffe auf den NSC .	'Paï¿½ auf! Ziel woanders	hin!' B_Orc_AssessThreat hat das auch noch
	var string WatchYourAimAngry;																// SC zielt mit einer Fernkampfwaffe auf den Angry-NSC. (genervte Auffordern, damit	aufzuhï¿½ren)
	var string WhatAreYouDoing;																	// NSC wird von einem FRIENDLY-SC/NSC geschlagen

// SC hat Waffe weggesteckt, NSC beendet Kampf
	var string LetsForgetOurLittleFight;														// Friede, kann direkt kommen ( Wenn freundliche kï¿½mpfen und der Spieler die Waffe wegsteckt) oder als Reaction ï¿½ber das news-Gedï¿½chtnis, sollte daher Zeitneutral sein (--> nicht wie jetzt lass uns den Streit von letztens vergessen

// NSC hat Gegner aus den Augen verloren
	var string Strange;																			// 1. NSC wird attackiert -> rennt mit gezogener Waffe zum Angreifer ->	kann ihn plï¿½tzlich nicht mehr entdecken	-> (muttering to himself)
																								// 2. NSC sieht	einen Mord -> rennt	mit	gezogener Waffe	zum	Mï¿½rder -> kann ihn plï¿½tzlich nicht mehr	entdecken
...
// NSC greift an!
	...
	var string NowWait;																			// NSC hat den SC frï¿½her noch NICHT besiegt -> SC greift den NSC an -> "Na warte!"
	var string YouStillNotHaveEnough;															// NSC hat den SC frï¿½her besiegt ->	SC greift den NSC an -> "Hast du immer noch nicht genug?!"

	var string YouAskedForIt;																	// 1. SC hat eine Aufforderung ignoriert: den Raum zu verlassen, ein Item zurï¿½ckzugeben, seine Waffe wegzustecken -> "Wer nicht hï¿½ren will muï¿½ fï¿½hlen..."
	var string NowWaitIntruder;																	// SC hat einen bewachten Durchgang durchbrochen...

	var string IWillTeachYouRespectForForeignProperty;											// 1. SC benutzt ein Besitz-Mob(Tï¿½r,Fallgitter-Drehkreuz,Kiste,...) und	wird ohne Vorwarnung attackiert
																								// 2. SC trï¿½gt Waffe des NSCs -> NSC ist stï¿½rker und holt sie sich mit Gewalt wieder ->	vorher dieser Spruch

	var string DirtyThief;																		// 1. NSC ertappt den (schwï¿½cheren)	SC mit den Fingern in den eigenen Taschen
																								// 2. NSC sieht	wie	der	(schwï¿½chere) SC	etwas nimmt, daï¿½ ihm gehï¿½rt	(z.B. Waffe	auf	den	Tisch)
																								// 3. NSC sieht	feindlichen, schwï¿½cheren SC, der ihn vorher	mal	beklaut	hat	und	sagt ihm diesen	Spruch,	bevor er angreift "Da hab ich Dich also	wieder,	Du dreckiger Dieb"
																								// 4. Nsc ist in einen Raum eingedrungen

	var string YouAttackedMyCharge;																// SC/NSC greift einen Schï¿½tzling einer NSC-Wache an -> Wache attackiert den Angreifer danach
	var string YouKilledOneOfUs;																// NSC erblickt feindlichen SC, der einen Freund des NSCs getï¿½tet hat -> Angriff!

// im Kampf
	var string Dead;																			// Tï¿½dlich verletzt
...
// SC hat NSC niedergeschlagen oder bedroht
	...
	var string YesYes;																			// 1. NSC wurde	im Kampf besiegt ->	erwacht	wieder ist aber	schï¿½cher als sein Kontrahent
																								// 2. SC zieht Waffe oder nï¿½hert sich mit Waffe und NSC ist schwï¿½cher als SC
// NSC flieht
	var string ShitWhatAMonster;																// NSC flieht vor zu starkem Monster -> "Scheiï¿½e, was ein Hï¿½llenvieh. Nichts wie weg!"
	var string Help;																			// NSC flieht vor Gegner, Babe Nsc flieht vor Spieler, Orcs haben das auch
	var string WeWillMeetAgain;																	// NSC flieht vor Gegner, ist aber eigentlich Stï¿½rker als er, ist aber trotzdem besiegt worden

// SC wurde von NSC besiegt und wird geplï¿½ndert
	var string NeverTryThatAgain;																// NSC hat Gegner besiegt -> ("Versuch das NIE wieder!!")
	var string ITakeYourWeapon;																	// NSC plï¿½ndert bewuï¿½tlosen SC/aNSC. Wï¿½hrend er sich bï¿½ckt, um nach der vom Besiegten fallengelassenen Waffe zu greifen sagt er diesen Spruch.
	var string ITookYourOre;																	// NSC plï¿½ndert bewuï¿½tlosen SC/aNSC. Nachdem er sich einen Teil des Erzes genommen hat, sagt er diesen Spruch.
	var string ShitNoOre;																		// NSC ï¿½rgert sich darï¿½ber, daï¿½ er beim Durchsuchen eines bewuï¿½tlosen/toten Kï¿½rpers kein Erz gefunden hat!

// NSC verwarnt SC
	var string HandsOff;																		// SC manipuliert ein MOB (Drehkreuz, Truhe, Tï¿½r) und ein befreundeter bzw. gildengleicher NSC sieht das...
	var string GetOutOfHere;																	// NSC erwischt	schwï¿½cheren	SC in seiner Hï¿½tte -> ("Raus hier")	(SC	soll aus Raum gehen)
	var string YouViolatedForbiddenTerritory;													// SC wird beim Betreten eines verbotenen Portalraums erwischt -> Warnung!

	var string YouWannaFoolMe;																	// SC schnappt NSC ein Item vor der Nase weg und wird mit $GiveItToMe aufgefordert es zurï¿½ckzugeben -> SC gibt ein falsches Item an den NSC -> 'Willst Du mich verarschen'
	...
	var string WhyAreYouInHere;																	// im ZS_ClearRoom / SC steht in verbotenem Portalraum	-> schwï¿½cherer NSC fragt
	var string WhatDidYouInThere;																// Wache sieht Sc aus einer Hï¿½tte rauskommen und verwarnt ihn, ohne das ein Angriff folgt
	...
	var string WiseMove;																		// 1. NSC wurde	gewarnt, seine Waffe wegzustecken ($RemoveYourWeapon) -> SC	befolgt	dies und steckt	die	Waffe weg
																								...
																								// 3. SC hat NSC ein Item vor der Nase weggeschnappt und wurde mit $GiveItToMe aufgefordert	es zurï¿½ckzugeben ->	SC gehorcht
...
// NSC alarmiert/warnt andere NSCs vor SC
	var string Alarm;																			// Wache alarmiert die Sichtung	eines permanent	HOSTILE	SC/aNSC	"Alaaaaaaarm!!!!!"
																								...
																								// Gemï¿½se (NpcWorker) ruft Wachen nach einem Diebstahl/beobachteten Diebstahl etc.
...
// NSC beobachtet Kampf
	var string TheresAFight;																	// NSC entdeckt	einen Kampf	und	will zuschauen (ZS_WatchFight) -> vorher ein Spruch	wie	"Hey da	drï¿½ben gibt's einen	Kampf"
	var string HeyHeyHey;																		// Hintergrund anfeuern	beim Beobachten	eines Kampfes: 'Hau	ihm	aufs Maul!'	(kommt alle	paar Sekunden!)
	var string CheerFight;																		// NSC ist im Zustand WatchFight: Neutraler	Kï¿½mpfer	schlï¿½gt irgendeinen Typen. '5 Erz auf den Dicken'
	...
	var string YeahWellDone;																	// NSC sieht, wie SC/aNSC, zu dem er ANGRY/HOSTILE ist getï¿½tet wird. 'Gut gemacht, das hat sie Sau verdient.'

// NSC-Gegner flieht
	var string RunCoward;																		// 1. Der NSC befindet sich	im Zustand WatchFight -> einer der Kï¿½mpfer haut	ab
	...
	var string HeKilledHim;																		// NSC sieht wie ein SC/aNSC einen anderen aNSC/SC tï¿½tet	(WICHTIG: dies ist ein Skandal, niemand wird normalerweise	in einer "Schlï¿½gerei" getï¿½tet)
	var string ItWasAGoodFight;																	// NSC sieht wie ein FRIENDLY/NEUTRAL-SC/aNSC einen	anderen	besiegt

	var string Awake;																			// NSC wacht aus dem Zustand Sleep wieder auf (Aufwachen, rï¿½keln)
...
// Grï¿½ï¿½e
	...
	var string ALGreetings;																		// 1. Am Anfang	eines Dialoges, wenn NSC und SC aus Altem Lager und FRIENDLY/NEUTRAL ('Fï¿½r Gomez'), 2. Wenn sie sich unterwegs begegnen.
	...
	var string SectGreetings;																	// 1. Am Anfang	eines Dialoges, wenn NSC aus Psi-Camp und FRIENDLY/NEUTRAL	zum	SC ('Erwache. Der Schlï¿½fer erwache.') 2. Wenn sie sich unterwegs begegnen.

	var string ThereHeIs;																		// NSC zeigt SC wo ein anderer NSC steht nach dem der SC gefragt hat: "Da drï¿½ben ist er"

// Lehrer-Kommentare
	var string NoLearnNoPoints;																	// NSC-Lehrer verbietet Steigerung - keine Lernpunkte!
	var string NoLearnOverMax;																	// NSC-Lehrer verbietet Attribut-Steigerung ï¿½ber 100
	var string NoLearnYouAlreadyKnow;															// Du muï¿½t erst Fortgeschritten sein, bevor du ein Meister werden kannst!
	var string NoLearnYoureBetter;																// Du bist jetzt schon besser!

// NSC spricht SC an
	var string HeyYou;																			// z.B. Wache, die den SC im Rï¿½umen erwischt, wo er nicht hin darf sagt HeyYou, und geht dann zum SC

// NSC will nicht reden
	var string NotNow;																			// NSC / Babe wird vom SC angesprochen,	lehnt aber ein Gesprï¿½ch	ab.

// SC zu nah
	var string WhatDoYouWant;																	// SC rï¿½ckt NSC zu dicht auf die Pelle -> "Kann ich was fï¿½r Dich tun?"
	var string ISaidWhatDoYouWant;																// NSC hat $WhatDoYouWant gesagt, aber der SC hat nicht reagiert -> "Was willst Du?"
// SC im Weg
	var string MakeWay;																			// SC steht	schwï¿½cherem NSC im Weg	-> Aufforderung, Platz zu	machen
	var string OutOfMyWay;																		// SC steht stï¿½rkerem NSC (Magier, Erzbaron) im Weg -> aggressive Aufforderung, Platz zu machen
	var string YouDeafOrWhat;																	// SC folgt	nicht der Aufforderung des stï¿½rkeren NSCs	-> letzte Warnung, danach Angriff

// SC spricht NSC an, der ihn besiegt hat
	var string LookingForTroubleAgain;															//Erster Satz eines Dialoges, nachdem der NSC und der SC gekï¿½mpft haben (entweder wurde der SC besiegt oder es gab keinen klaren Ausgang des Kampfes)

// NSC ist schwï¿½cher...
	var string LookAway;																		// Eingeschï¿½chterter NSC guckt weg bei bedrohlichen Situationen
	var string OkayKeepIt;																		// SC trï¿½gt	Waffe des schï¿½cheren NSCs -> NSCs verlangt die Waffe zurï¿½ck	($GiveItToMe) -> SC	bedroht	NSC	-> ("Okay, okay, du	kannst das Ding	behalten..." zurï¿½ckweichen)
	...
	var string ThatsMyWeapon;																	// SC trï¿½gt	eine Waffe,	die	dem	NSC	gehï¿½rt -> Folge: ZS_GetBackBelongings
	var string GiveItToMe;																		// 1. SC trï¿½gt Waffe des NSCs -> NSC ist schwï¿½cher (also kein Kampf) ->	"Gib sie mir wieder"
	var string YouCanKeeptheCrap;																// 1. SC trï¿½gt Waffe des schwï¿½cheren NSCs ->	NSCs verlangt die Waffe	zurï¿½ck ($GiveItToMe) ->	SC geht	einfach	weg	-> ("Behalt	das	Scheiï¿½-Ding	doch!)
																								// 2. NSC will ein Item	aufheben und wird von einem	stï¿½rkeren NSC gewarnt, der das auch	tun	will ->	unser NSC weicht zurï¿½ck

	var string TheyKilledMyFriend;																// NSC Tï¿½ter - NSC zu Opfer freundlich, zu Tï¿½ter freundlich oder neutral
...
// Angry NSCs kommentieren SC-Aktionen
	var string SuckerGotSome;																	// Angry NSC hat gehï¿½rt, daï¿½ der SC umgehauen wurde. "Das Dich jemand umgehauen hat, geschieht Dir Recht!"
	...
	var string SuckerDefeatedVLK_Guard;															// Der Spieler hat einen Schï¿½tzling der Wache niedergeschlagen
	var string YouDefeatedMyComrade;															// Wache stellt fest, das sie gesehen/gehï¿½rt hat, daï¿½ ich eine andere Wache umgehauen habe
...
//Wichtige Person (Lehrer, Auftraggeber?), hat davon gehï¿½rt, daï¿½ Du Mist gebaut hat...
// FIXME: damit das so benutzt werden kann mï¿½ssen noch Anpassungen in der B_ReactToMemory.d gemacht werden
	...
	var string YouKilledMyFriend;																// jemand aus eigener oder befreundeter Gilde getï¿½tet
	var string YouKilledEBr;																	// Erzbaron getï¿½tet
	var string YouKilledGur;																	// Guru getï¿½tet
	var string YouKilledMage;																	// Guru getï¿½tet

	var string YouKilledOCfolk;																	// Gardist, Schatten oder Buddler getï¿½tet.
	var string YouKilledNCfolk;																	// Sï¿½ldner, Organisator, Schï¿½rfer oder Bauer getï¿½tet
	var string YouKilledPSIfolk;																// Templer oder Novize getï¿½tet

	var string GetThingsRight;																	// SC hat Mist gebaut. NSC sagt, "Das wieder hinzubiegen wird nicht einfach!"

	var string YouDefeatedMeWell;																// Zu SC	freundlich/neutral:	Du hast	mich ganz schï¿½n	geplï¿½ttet

// Ambient-Unterhaltungen zwischen zwei NSCs (gemurmelte Wortfetzen, die zufï¿½llig zu "Dialogen" zusammengewï¿½rfelt werden...
	...
	var string Smalltalk06;																		// ...war doch klar, daï¿½ das ï¿½rger gibt...
	var string Smalltalk07;																		// ...aber behalt's fï¿½r Dich, muï¿½ nicht gleich jeder wissen...
	var string Smalltalk08;																		// ...das passiert mir nicht nochmal...
	var string Smalltalk09;																		// ...an der Gechichte muï¿½ wohl doch was dran sein...
	var string Smalltalk10;																		// ...man muï¿½ eben aufpassen was man rumerzï¿½hlt...
	var string Smalltalk11;																		// ...solange ich damit nichts zu tun habe...
	var string Smalltalk12;																		// ...man darf auch nicht alles glauben, was man hï¿½rt...
	...
	var string Smalltalk16;																		// ...frï¿½her wï¿½re das ganz anders gelaufen...
	var string Smalltalk17;																		// ...gequatscht wird viel...
	var string Smalltalk18;																		// ...ich hï¿½r nicht mehr auf das Gefasel...
	var string Smalltalk19;																		// ...verlaï¿½ Dich auf jemanden und Du bist verlassen, das ist eben so...
	var string Smalltalk20;																		// ...ich glaube kaum, daï¿½ sich daran was ï¿½ndern wird...
	var string Smalltalk21;																		// ...wahrscheinlich hast Du recht...
	var string Smalltalk22;																		// ...erstmal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird...
	var string Smalltalk23;																		// ...ich dachte, das wï¿½re schon lange geklï¿½rt, aber das ist wohl nicht so...
	var string Smalltalk24;																		// ...laï¿½ uns lieber ï¿½ber was anderes reden...
	var string Om;																				// Ommm (Meditation)

// SC Dialog
	var string SC_HeyTurnAround;																//SC: Hey du! (Nsc ansprechen, steht mit Rï¿½cken zu dir)
...
// ********************************
//		Die SVM-Instanzen		(ToDo: News noch ï¿½berarbeiten wie in Prototypen)
// ********************************

// Die einzelnen Instanzen der SVMs
// Diese mï¿½ssen	immer "SVM_x" heissen, wobei x die VoiceNummer ist.

instance SVM_1 (C_SVM) //Malocher (Volk, Schï¿½rfer) Nï¿½rgler, Alkoholiker, schimpft ï¿½ber alles - zieht Kraft aus seinem Hass
{
	StopMagic								= "SVM_1_StopMagic";								//Hï¿½r auf mit dieser Magie-Scheiï¿½e!
	ISaidStopMagic							= "SVM_1_ISaidStopMagic";							//Willst du Schlï¿½ge? Hï¿½r sofort damit auf!!!
	WeaponDown								= "SVM_1_WeaponDown";								//Steck die Waffe weg!
	ISaidWeaponDown							= "SVM_1_ISaidWeaponDown";							//Steck endlich die Scheiï¿½waffe weg!!
	...
	NowWaitIntruder							= "SVM_1_NowWaitIntruder";							//Jetzt sorg ich dafï¿½r, dass du in Einzelteilen hier weggeschafft wirst!
	...
	ShitWhatAMonster						= "SVM_1_ShitWhatAMonster";							//Scheiï¿½e! Nichts wie weg!
	...
	ITookYourOre							= "SVM_1_ITookYourOre";								//Danke fï¿½r das Erz, du Held!
	...
	WhyAreYouInHere							= "SVM_1_WhyYouAreInHere";							//Raus aus meiner Hï¿½tte oder ich ruf die Wachen!
	...
	CheerFight								= "SVM_1_CheerFight";								//Ihr kï¿½mpft wie Frauen!
	CheerFriend								= "SVM_1_CheerFriend";								//Mach ihn alle!!
	Ooh										= "SVM_1_Ooh";										//Schlag doch zurï¿½ck!
	YeahWellDone							= "SVM_1_YeahWellDone";								//Gib's ihm!
	RunCoward								= "SVM_1_RunCoward";								//Komm zurï¿½ck, du Feigling!
	...
	ItWasAGoodFight							= "SVM_1_ItWasAGoodFight";							//Schï¿½ner Kampf!
	Awake									= "SVM_1_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_1_FriendlyGreetings";						//Hallo
	ALGreetings								= "SVM_1_ALGreetings";								//Fï¿½r Gomez!
	MageGreetings							= "SVM_1_MageGreetings";							//Magie zu Ehren!
	SectGreetings							= "SVM_1_SectGreetings";							//Erwache!
	ThereHeIs								= "SVM_1_ThereHeIs";								//Da drï¿½ben ist er.
	NoLearnNoPoints							= "SVM_1_NoLearnNoPoints";							//Komm wieder, wenn du mehr Erfahrung hast.
	NoLearnOverMax							= "SVM_1_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_1_ISaidWhatDoYouWant";						//Kann ich irgendwas fï¿½r dich tun?!
	...
	LookAway								= "SVM_1_LookAway";									//ï¿½ï¿½ï¿½h! Ich hab nichts gesehen!
	...
	SuckerDefeatedEBr						= "SVM_1_SuckerDefeatedEBr";						//Du hast einen Erzbaron umgehauen. Er ist so richtig wï¿½tend!
	SuckerDefeatedGur						= "SVM_1_SuckerDefeatedGur";						//Du hast einen Guru niedergeschlagen. Irgendwie ziehst du ï¿½rger an!
	SuckerDefeatedMage						= "SVM_1_SuckerDefeatedMage";						//Einen Magier zu besiegen ist 'ne wirklich beschissene Idee!
	SuckerDefeatedNov_Guard					= "SVM_1_SuckerDefeatedNov_Guard";					//Du kannst hier nicht rumrennen und die Novizen verprï¿½geln!
	...
	YouDefeatedNOV_Guard					= "SVM_1_YouDefeatedNOV_Guard";						//Das lï¿½uft nicht, dass du hier Unruhe stiftest!
	YouDefeatedVLK_Guard					= "SVM_1_YouDefeatedVLK_Guard";						//Wenn du jemanden verprï¿½gelst, der unter meinem Schutz steht, hat das Konsequenzen!
	...
	YouStoleFromEBr							= "SVM_1_YouStoleFromEBr";							//Du hast die Erzbarone beklaut! Was soll der Scheiï¿½?
	YouStoleFromGur							= "SVM_1_YouStoleFromGur";							//Du hast die Gurus beklaut? Dumm nur, dass es rausgekommen ist!
	StoleFromMage							= "SVM_1_StoleFromMage";							//Du hast die Magier beklaut! Eine echt dï¿½mliche Idee!
	...
	YouKilledGur							= "SVM_1_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_1_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_1_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_1_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_1_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_1_YouDefeatedMeWell";						//War ein guter Kampf. Du hast mir ganz schï¿½n aufs Maul gehauen, Mann!
	Smalltalk01								= "SVM_1_Smalltalk01";								// ... der letzte Scheiï¿½ ...
	...
	Smalltalk06								= "SVM_1_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	...
	Smalltalk16								= "SVM_1_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_1_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_1_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_1_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_1_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_1_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_1_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_1_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_1_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_1_Om";										// Ommm
};

//SVM_2	// Misstrauisch (Volk, Bauern, Novizen, MILTEN) Misstrauisch. Defensiv. Angst in was reingezogen zu werden. Klug. Nov: Glauben durch Einschï¿½chterung
...
instance SVM_2 (C_SVM) // Misstrauisch
{
	...
	WatchYourAimAngry						= "SVM_2_WatchYourAimAngry";						//Wenn du weiter auf mich anlegst, muss ich das wohl persï¿½nlich nehmen!
	...
	DieMortalEnemy							= "SVM_2_DieMortalEnemy";							//Ich befï¿½rchte, ich muss dich beseitigen!
	...
	NowWaitIntruder							= "SVM_2_NowWaitIntruder";							//Du weiï¿½t doch, dass du hier nichts zu Suchen hast!
	IWillTeachYouRespectForForeignProperty	= "SVM_2_IWillTeachYouRespectForForeignProperty";	//Warum fummelst du auch an Sachen rum, die dir nicht gehï¿½ren?!
	DirtyThief								= "SVM_2_DirtyThief";								//Du hast mich beklaut! Das nehme ich dir echt ï¿½bel!
	YouAttackedMyCharge						= "SVM_2_YouAttackedMyCharge";						//Niemand vergreift sich an meinen Jungs!
	YouKilledOneOfUs						= "SVM_2_YouKilledOneOfUs";							//Du hast einen von uns umgebracht! Dafï¿½r musst du bï¿½ï¿½en!
	...
	ShitWhatAMonster						= "SVM_2_ShitWhatAMonster";							//Ich - ï¿½hm - geh' Hilfe holen!
	...
	WhyAreYouInHere							= "SVM_2_WhyYouAreInHere";							//Raus aus meiner Hï¿½tte oder ich ruf die Wachen!
	WhatDidYouInThere						= "SVM_2_WhatDidYouInThere";						//Bleib aus den Hï¿½tten drauï¿½en!
	...
	CheerFight								= "SVM_2_CheerFight";								//Nicht so mï¿½de!
	...
	ISaidWhatDoYouWant						= "SVM_2_ISaidWhatDoYouWant";						//Kann ich was fï¿½r dich tun?
	MakeWay									= "SVM_2_MakeWay";									//Lass mich mal vorbei!
	OutOfMyWay								= "SVM_2_OutOfMyWay";								//Mach Platz!
	YouDeafOrWhat							= "SVM_2_YouDeafOrWhat";							//Verschwinde, sonst lauf ich ï¿½ber dich drï¿½ber!
	...
	OkayKeepIt								= "SVM_2_OkayKeepIt";								//Schon gut! Es gehï¿½rt dir!
	...
	TheyKilledMyFriend						= "SVM_2_TheyKilledMyFriend";						//Jemand hat einen von uns getï¿½tet! Wenn wir den erwischen, ist er dran!
	...
	SuckerDefeatedNov_Guard					= "SVM_2_SuckerDefeatedNov_Guard";					//Ich sorge dafï¿½r, dass hier Ruhe herrscht!
	SuckerDefeatedVlk_Guard					= "SVM_2_SuckerDefeatedVlk_Guard";					//Egal worum es ging! Wenn du einen Buddler schlï¿½gst, gibt's ï¿½rger!
	...
	YouDefeatedVLK_Guard					= "SVM_2_YouDefeatedVLK_Guard";						//Keine Schlï¿½gereien mit meinen Jungs! Verstanden?
	YouStoleFromMe							= "SVM_2_YouStoleFromMe";							//Wieso hast du mich beklaut?
	YouStoleFromUs							= "SVM_2_YouStoleFromUs";							//Du hast da etwas, das uns gehï¿½rt. Das mï¿½chten wir gerne zurï¿½ck haben!
	YouStoleFromEBr							= "SVM_2_YouStoleFromEBr";							//Mann! Du hast die Erzbarone beklaut! Die werden toben!
	YouStoleFromGur							= "SVM_2_YouStoleFromGur";							//Du hast die Gurus beklaut! Wenn du dich wenigstens nicht erwischen lassen wï¿½rdest!
	StoleFromMage							= "SVM_2_StoleFromMage";							//Die Magier mï¿½gen es nicht, wenn man in ihren Sachen rumstï¿½bert!
	...
	YouKilledGur							= "SVM_2_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_2_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	...
	YouKilledPSIfolk						= "SVM_2_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint hast du ihn beseitigt!
	...
	Smalltalk06								= "SVM_2_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_2_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_2_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_2_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_2_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_2_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_2_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_2_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_2_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_2_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_2_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_2_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_2_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_2_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_2_Om";										// Ommm
};

instance SVM_3 (C_SVM) // Depressiv (Resigniert. Menschliches Gemï¿½se. "Ich schau nochï¿½n bisschen an die Decke.." , "Wir sind eh alle verloren..." Nov:Glauben an Drogen
{
	...
	WatchYourAimAngry						= "SVM_3_WatchYourAimAngry";						//Waffe runter, sonst werd ich bï¿½se!
	WhatAreYouDoing							= "SVM_3_WhatAreYouDoing";							//Heeeeeey! Was soll der Scheiï¿½??
	LetsForgetOurLittleFight				= "SVM_3_LetsForgetOurLittleFight";					//Nun gut, wir betrachten unsere Auseinandersetzung als Missverstï¿½ndnis.
	...
	ShitWhatAMonster						= "SVM_3_ShitWhatAMonster";							//Scheiï¿½e! Nichts wie weg!
	...
	ITakeYourWeapon							= "SVM_3_ITakeYourWeapon";							//Danke fï¿½r die Waffe!
	...
	WhatsThisSupposedToBe					= "SVM_3_WhatsThisSupposedToBe";					//Hï¿½r auf, hier herumzuschleichen!
	WhyAreYouInHere							= "SVM_3_WhyYouAreInHere";							//Verschwinde aus meiner Hï¿½tte oder ich rufe die Wachen!
	WhatDidYouInThere						= "SVM_3_WhatDidYouInThere";						//Was machst du da? Wenn ich dich erwische, bist du dran!
	WiseMove								= "SVM_3_WiseMove";									//Du weiï¿½t ja doch, was gut fï¿½r dich ist!
	...
	HeDeservedIt							= "SVM_3_HeDeservedIt";								//Das war schon lï¿½nger fï¿½llig!
	HeKilledHim								= "SVM_3_HeKilledHim";								//Der bewegt sich nicht mehr. Du hast ihn umgebracht!
	ItWasAGoodFight							= "SVM_3_ItWasAGoodFight";							//Immer nur Kï¿½mpfe ...
	Awake									= "SVM_3_Awake";									//Ein neuer Tag und nichts hat sich geï¿½ndert ...
	FriendlyGreetings						= "SVM_3_FriendlyGreetings";						//Hey, Mann.
	ALGreetings								= "SVM_3_ALGreetings";								//Fï¿½r Gomez, ja, ja.
	MageGreetings							= "SVM_3_MageGreetings";							//Magie zu Ehren!
	SectGreetings							= "SVM_3_SectGreetings";							//Erwache!
	ThereHeIs								= "SVM_3_ThereHeIs";								//Da drï¿½ben ist er.
	NoLearnNoPoints							= "SVM_3_NoLearnNoPoints";							//Du hast nicht genug Erfahrung. Ich kann dir das nicht beibringen!
	NoLearnOverMax							= "SVM_3_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_3_ISaidWhatDoYouWant";						//Kann ich irgendwas fï¿½r dich tun?
	...
	YouDisturbedMySlumber					= "SVM_3_YouDisturbedMySlumber";					//Warum reiï¿½t du mich aus den Trï¿½umen?
	SuckerGotSome							= "SVM_3_SuckerGotSome";							//Geschieht dir Recht, dass du 'ne Abreibung bekommen hast!
	SuckerDefeatedEBr						= "SVM_3_SuckerDefeatedEBr";						//Du hast einen Erzbaron besiegt! Du suchst wohl immer nach ï¿½rger, Mann!
	SuckerDefeatedGur						= "SVM_3_SuckerDefeatedGur";						//Du hast einen der Gurus besiegt. Das nehmen sie dir echt ï¿½bel!
	SuckerDefeatedMage						= "SVM_3_SuckerDefeatedMage";						//Einen Magier zu besiegen wird groï¿½en ï¿½rger geben!
	SuckerDefeatedNov_Guard					= "SVM_3_SuckerDefeatedNov_Guard";					//Die Novizen solltest du nï¿½chstes Mal in Ruhe lassen!
	...
	YouDefeatedVLK_Guard					= "SVM_3_YouDefeatedVLK_Guard";						//Die Buddler bezahlen mich, damit sie keinen ï¿½rger haben! So soll das auch bleiben!
	YouStoleFromMe							= "SVM_3_YouStoleFromMe";							//Du hast mich bestohlen, du dreckiger Dieb?
	YouStoleFromUs							= "SVM_3_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	...
	YouKilledGur							= "SVM_3_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_3_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_3_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_3_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und du hast ihn auf dem Gewissen!
	GetThingsRight							= "SVM_3_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_3_YouDefeatedMeWell";						//War ein fairer Kampf! Schwamm drï¿½ber, dass du mich umgehauen hast!
	...
	Smalltalk06								= "SVM_3_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_3_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_3_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_3_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_3_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_3_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_3_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_3_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_3_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_3_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_3_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_3_Smalltalk22";								// ... erst mal abwarten. Es wird lï¿½ngst nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_3_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_3_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_3_Om";										// Ommm
};

instance SVM_4 (C_SVM) // Alter Sack, (Torrez, KDF-Magier, alte Buddler....), alter Hase. Kann Grï¿½nschnï¿½beln noch was zeigen
{
	StopMagic								= "SVM_4_StopMagic";								//Steck lieber die Magie weg!
	ISaidStopMagic							= "SVM_4_ISaidStopMagic";							//Hï¿½r besser auf meinen Rat und steck die Magie weg!
	WeaponDown								= "SVM_4_WeaponDown";								//Steck die Waffe weg, wenn du keinen ï¿½rger willst!
	...
	WatchYourAimAngry						= "SVM_4_WatchYourAimAngry";						//Wenn du nicht aufhï¿½rst, nehme ich dir das Spielzeug weg!
	...
	DieMonster								= "SVM_4_DieMonster";								//Egal wie viele man tï¿½tet, es werden einfach nicht weniger!
	DieMortalEnemy							= "SVM_4_DieMortalEnemy";							//ï¿½lter wirst du nicht mehr!
	...
	IWillTeachYouRespectForForeignProperty	= "SVM_4_IWillTeachYouRespectForForeignProperty";	//Du kannst nicht einfach ungestraft ï¿½berall rumfummeln!
	...
	YouKilledOneOfUs						= "SVM_4_YouKilledOneOfUs";							//Du hast einen von uns getï¿½tet! Dein Leben fï¿½r seins!
	...
	Help									= "SVM_4_Help";										//Ich bin zu alt fï¿½r so was!
	...
	ITookYourOre							= "SVM_4_ITookYourOre";								//Dein Erz ist bei mir in besseren Hï¿½nden!
	...
	YouWannaFoolMe							= "SVM_4_YouWannaFoolMe";							//Ich bin nicht in der Stimmung fï¿½r solche Scherze!
	...
	WiseMove								= "SVM_4_WiseMove";									//Da hast du noch mal Glï¿½ck gehabt.
	...
	Ooh										= "SVM_4_Ooh";										//Schlag mal zurï¿½ck!
	...
	HeKilledHim								= "SVM_4_HeKilledHim";								//Du hast ihn umgebracht! Das war ein groï¿½er Fehler!
	ItWasAGoodFight							= "SVM_4_ItWasAGoodFight";							//Frï¿½her waren die Kï¿½mpfe besser.
	Awake									= "SVM_4_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_4_FriendlyGreetings";						//Sei gegrï¿½ï¿½t.
	ALGreetings								= "SVM_4_ALGreetings";								//Fï¿½r Gomez!
	MageGreetings							= "SVM_4_MageGreetings";							//Magie zu Ehren!
	SectGreetings							= "SVM_4_SectGreetings";							//Erwache!
	ThereHeIs								= "SVM_4_ThereHeIs";								//Du findest ihn dort drï¿½ben.
	NoLearnNoPoints							= "SVM_4_NoLearnNoPoints";							//Ich kann dir nichts beibringen. Du hast nicht genug Erfahrung.
	NoLearnOverMax							= "SVM_4_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	LookAway								= "SVM_4_LookAway";									//Nichts sehen, nichts hï¿½ren, nichts reden ...
	OkayKeepIt								= "SVM_4_OkayKeepIt";								//Behalt es doch einfach!
	WhatsThat								= "SVM_4_WhatsThat";								//Was war denn das?
	ThatsMyWeapon							= "SVM_4_ThatsMyWeapon";							//Rï¿½ck mal schï¿½n meine Waffe wieder raus!
	...
	YouDisturbedMySlumber					= "SVM_4_YouDisturbedMySlumber";					//Du stï¿½rst meine Nachtruhe!
	SuckerGotSome							= "SVM_4_SuckerGotSome";							//Du bist umgehauen worden! 'ne kleine Abreibung hattest du auch mal nï¿½tig!
	...
	SuckerDefeatedVlk_Guard					= "SVM_4_SuckerDefeatedVlk_Guard";					//Was fï¿½llt dir eigentlich ein, einen Buddler zu verkloppen ?
	...
	YouDefeatedVLK_Guard					= "SVM_4_YouDefeatedVLK_Guard";						//Du bist echt zu mutig, einen meiner Schï¿½tzlinge anzufassen, kann dich teuer zu stehen kommen.
	YouStoleFromMe							= "SVM_4_YouStoleFromMe";							//Lass bloï¿½ die Finger von meinen Sachen, verstanden?
	YouStoleFromUs							= "SVM_4_YouStoleFromUs";							//Du hast da etwas, was uns gehï¿½rt. Gib es uns wieder!
	YouStoleFromEBr							= "SVM_4_YouStoleFromEBr";							//Mann! Du hast die Erzbarone beklaut! Die werden toben!
	YouStoleFromGur							= "SVM_4_YouStoleFromGur";							//Du hast die Gurus beklaut! Wenn du dich wenigstens nicht erwischen lassen wï¿½rdest!
	StoleFromMage							= "SVM_4_StoleFromMage";							//Die Magier mï¿½gen es nicht, wenn man in ihren Sachen rumstï¿½bert!
	...
	YouKilledGur							= "SVM_4_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_4_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_4_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist tot und du sollst damit zu tun haben ...
	YouKilledNCfolk							= "SVM_4_YouKilledNCfolk";							//Im Neuen Lager steht wieder 'ne Hï¿½tte leer, und scheinbar hast du damit zu tun!
	YouKilledPSIfolk						= "SVM_4_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer, und wie es scheint, hast du ihn beseitigt!
	GetThingsRight							= "SVM_4_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_4_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_4_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_4_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_4_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_4_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_4_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_4_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_4_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_4_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_4_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_4_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_4_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_4_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_4_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_4_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_4_Om";										// Ommm
};

instance SVM_5 (C_SVM) //Lebenskï¿½nstler, offen, Frï¿½hlich. humorvoller Verarscher. Auch: Fauler Verpisser. Selbstbewuï¿½t, wortgewandt, charismatisch. (Lester)
{
	...
	WatchYourAimAngry						= "SVM_5_WatchYourAimAngry";						//Wenn du nicht aufhï¿½rst, dann ï¿½be ich gleich auch mal mit dir!
	...
	DieMonster								= "SVM_5_DieMonster";								//Du bist fï¿½llig, Mistvieh!
	...
	NowWaitIntruder							= "SVM_5_NowWaitIntruder";							//Hier werden sie dich raustragen mï¿½ssen!
	IWillTeachYouRespectForForeignProperty	= "SVM_5_IWillTeachYouRespectForForeignProperty";	//Ich hab' dich gewarnt. Wer an meine Sachen geht, kriegt ï¿½rger!
	...
	ShitWhatAMonster						= "SVM_5_ShitWhatAMonster";							//Das ist 'ne Nummer zu groï¿½ fï¿½r mich!
	Help									= "SVM_5_Help";										//Verdammt!
	WeWillMeetAgain							= "SVM_5_WeWillMeetAgain";							//Beim nï¿½chsten Mal sieht die Sache wieder anders aus!
	NeverTryThatAgain						= "SVM_5_NeverTryThatAgain";						//Versuch das nicht noch mal!
	ITakeYourWeapon							= "SVM_5_ITakeYourWeapon";							//Die Waffe gefï¿½llt mir!
	ITookYourOre							= "SVM_5_ITookYourOre";								//Ich sorg dafï¿½r, dass dein Erz gut angelegt wird!
	...
	RunCoward								= "SVM_5_RunCoward";								//Der Typ verdrï¿½ckt sich!
	HeDefeatedHim							= "SVM_5_HeDefeatedHim";							//Klarer Sieger wï¿½rde ich sagen!
	...
	ItWasAGoodFight							= "SVM_5_ItWasAGoodFight";							//Was fï¿½r ein Kampf!
	Awake									= "SVM_5_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_5_FriendlyGreetings";						//Hi Ho Kumpel!
	ALGreetings								= "SVM_5_ALGreetings";								//Fï¿½r Gomez!
	MageGreetings							= "SVM_5_MageGreetings";							//Magie zu Ehren!
	SectGreetings							= "SVM_5_SectGreetings";							//Erwache!
	ThereHeIs								= "SVM_5_ThereHeIs";								//Da drï¿½ben.
	NoLearnNoPoints							= "SVM_5_NoLearnNoPoints";							//So unerfahren, wie du bist, kann ich dir nichts beibringen.
	NoLearnOverMax							= "SVM_5_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ThatsMyWeapon							= "SVM_5_ThatsMyWeapon";							//Ich wï¿½rde es vorziehen, meine Waffe zurï¿½ckzubekommen!
	...
	SuckerDefeatedVlk_Guard					= "SVM_5_SuckerDefeatedVlk_Guard";					//Was fï¿½llt dir eigentlich ein, einen Buddler zu verkloppen ?
	...
	YouDefeatedVLK_Guard					= "SVM_5_YouDefeatedVLK_Guard";						//Du bist echt zu mutig, einen meiner Schï¿½tzlinge anzufassen, kann dich teuer zu stehen kommen.
	YouStoleFromMe							= "SVM_5_YouStoleFromMe";							//Du wagst es, mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_5_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	YouStoleFromEBr							= "SVM_5_YouStoleFromEBr";							//Mann! Du hast die Erzbarone beklaut! Die werden toben!
	YouStoleFromGur							= "SVM_5_YouStoleFromGur";							//Du hast die Gurus beklaut! Wenn du dich wenigstens nicht erwischen lassen wï¿½rdest!
	StoleFromMage							= "SVM_5_StoleFromMage";							//Die Magier mï¿½gen es nicht, wenn man in ihren Sachen rumstï¿½bert!
	...
	YouKilledGur							= "SVM_5_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_5_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	...
	YouKilledPSIfolk						= "SVM_5_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint hast du ihn beseitigt!
	GetThingsRight							= "SVM_5_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_5_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_5_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_5_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_5_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_5_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_5_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_5_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_5_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_5_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_5_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_5_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_5_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_5_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_5_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_5_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_5_Om";										//Ommm
};

//////////////////////////////////////////
instance SVM_6 (C_SVM) //Raufbold (Will saufen und raufen (Matrose) Alkoholiker. Grï¿½lt viel)
{
	StopMagic								= "SVM_6_StopMagic";								//Hï¿½r auf mit der Magie-Scheiï¿½e!
	ISaidStopMagic							= "SVM_6_ISaidStopMagic";							//Magie weg! Sofort!!
	WeaponDown								= "SVM_6_WeaponDown";								//Steck die scheiï¿½ Waffe weg!
	...
	IWillTeachYouRespectForForeignProperty	= "SVM_6_IWillTeachYouRespectForForeignProperty";	//Ich hab' dich gewarnt. Wer an meine Sachen geht, kriegt ï¿½rger!
	...
	ShitWhatAMonster						= "SVM_6_ShitWhatAMonster";							//Verdammt, was fï¿½r ein Vieh! Nichts wie weg!
	...
	ITookYourOre							= "SVM_6_ITookYourOre";								//Danke fï¿½r das Erz, ich trink einen auf dich mit!
	ShitNoOre								= "SVM_6_ShitNoOre";								//Scheiï¿½e, nicht mal Erz dabei...
	...
	WiseMove								= "SVM_6_WiseMove";									//Glï¿½ck gehabt!
	...
	CheerFight								= "SVM_6_CheerFight";								//Ihr kï¿½mpft wie Frauen!
	...
	RunCoward								= "SVM_6_RunCoward";								//Feigling, komm zurï¿½ck!
	...
	Awake									= "SVM_6_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_6_FriendlyGreetings";						//Hallo.
	ALGreetings								= "SVM_6_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_6_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	YouDeafOrWhat							= "SVM_6_YouDeafOrWhat";							//Weg da! Oder soll ich's in dich reinprï¿½geln?
	LookingForTroubleAgain					= "SVM_6_LookingForTroubleAgain";					//Willst du wieder ï¿½rger?
	...
	ThatsMyWeapon							= "SVM_6_ThatsMyWeapon";							//Rï¿½ck mal meine Waffe raus, Witzbold!
	...
	SuckerDefeatedEBr						= "SVM_6_SuckerDefeatedEBr";						//Du hast einen Erzbaron umgehauen. Er ist so richtig wï¿½tend!
	SuckerDefeatedGur						= "SVM_6_SuckerDefeatedGur";						//Du hast einen Guru niedergeschlagen. Irgendwie ziehst du ï¿½rger an!
	SuckerDefeatedMage						= "SVM_6_SuckerDefeatedMage";						//Einen Magier zu besiegen ist 'ne wirklich beschissene Idee, Mann!
	SuckerDefeatedNov_Guard					= "SVM_6_SuckerDefeatedNov_Guard";					//Du kannst hier nicht rumrennen und die Novizen verprï¿½geln!
	...
	YouDefeatedNOV_Guard					= "SVM_6_YouDefeatedNOV_Guard";						//Das lï¿½uft nicht, dass du hier Unruhe stiftest!
	YouDefeatedVLK_Guard					= "SVM_6_YouDefeatedVLK_Guard";						//Wenn du jemand verprï¿½gelst, der unter meinem Schutz steht, hat das Konsequenzen!
	...
	YouStoleFromEBr							= "SVM_6_YouStoleFromEBr";							//Du hast die Erzbarone beklaut! Was soll der Scheiï¿½?
	YouStoleFromGur							= "SVM_6_YouStoleFromGur";							//Du hast die Gurus beklaut? Zu blï¿½d, dass es rausgekommen ist!
	StoleFromMage							= "SVM_6_StoleFromMage";							//Du hast die Magier beklaut! Eine echt beschissene Scheiï¿½idee!
	...
	YouKilledGur							= "SVM_6_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_6_YouKilledMage";							//Du hast einen Magier umgebracht! Wie zum Teufel sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_6_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist tot und Dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_6_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_6_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_6_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_6_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_6_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_6_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_6_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_6_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_6_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_6_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_6_Smalltalk18";								// ... hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_6_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_6_Smalltalk20";								// ... glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_6_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_6_Smalltalk22";								// ... erst mal abwarten. Wird nich' so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_6_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_6_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_6_Om";										//Ommm
};
...
instance SVM_7 (C_SVM) //Freak, Aggressiv. Spielt mit seiner Macht. Sadist. Org: Abschaum, den im AL keiner wollte. Nov (selten): Durchgeknallter Abschaum.
{
	...
	YouAttackedMyCharge						= "SVM_7_YouAttackedMyCharge";						//Wenn hier jemand Prï¿½gel austeilt, bin ich das!
	...
	ITookYourOre							= "SVM_7_ITookYourOre";								//Lieber wï¿½rde ich dich umbringen, aber das Erz ist auch nicht schlecht!
	ShitNoOre								= "SVM_7_ShitNoOre";								//Kein Erz? Du nutzloses Stï¿½ck Dreck!
	...
	YouWannaFoolMe							= "SVM_7_YouWannaFoolMe";							//Du versuchst tatsï¿½chlich mich zu verarschen!
	...
	WiseMove								= "SVM_7_WiseMove";									//Dein Glï¿½ck! Aber ich hï¿½tte dir auch gerne die Fresse poliert!
	...
	HeKilledHim								= "SVM_7_HeKilledHim";								//Du bist wirklich lebensmï¿½de, vor Zeugen jemanden kaltzumachen.
	...
	ALGreetings								= "SVM_7_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_7_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_7_ISaidWhatDoYouWant";						//Kann ich was fï¿½r dich tun?!
	...
	ThatsMyWeapon							= "SVM_7_ThatsMyWeapon";							//Gib mir meine Waffe zurï¿½ck!
	GiveItToMe								= "SVM_7_GiveItToMe";								//Her damit!
	YouCanKeeptheCrap						= "SVM_7_YouCanKeeptheCrap";						//Auch gut! Behalt es! Ich finde 'ne andere Lï¿½sung!
	...
	SuckerDefeatedEBr						= "SVM_7_SuckerDefeatedEBr";						//Du hast einen Erzbaron umgehauen. Er ist so richtig wï¿½tend!
	SuckerDefeatedGur						= "SVM_7_SuckerDefeatedGur";						//Du hast einen Guru niedergeschlagen. Irgendwie ziehst du ï¿½rger an!
	SuckerDefeatedMage						= "SVM_7_SuckerDefeatedMage";						//Einen Magier zu besiegen ist 'ne wirklich beschissene Idee!
	SuckerDefeatedNov_Guard					= "SVM_7_SuckerDefeatedNov_Guard";					//Du verprï¿½gelst also die Novizen!
	...
	YouDefeatedNOV_Guard					= "SVM_7_YouDefeatedNOV_Guard";						//Das lï¿½uft nicht, dass du hier Unruhe stiftest!
	YouDefeatedVLK_Guard					= "SVM_7_YouDefeatedVLK_Guard";						//Wenn du jemand verprï¿½gelst, der unter meinem Schutz steht, hat das Konsequenzen!
	...
	YouStoleFromEBr							= "SVM_7_YouStoleFromEBr";							//Du hast die Erzbarone beklaut! Was soll der Scheiï¿½?
	YouStoleFromGur							= "SVM_7_YouStoleFromGur";							//Du hast die Gurus beklaut? Zu blï¿½d, dass es rausgekommen ist!
	...
	YouKilledGur							= "SVM_7_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_7_YouKilledMage";							//Du hast einen Magier umgebracht! Wie zum Teufel sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_7_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist tot und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_7_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_7_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_7_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_7_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_7_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_7_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_7_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_7_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_7_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_7_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_7_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_7_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_7_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_7_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_7_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_7_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_7_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_7_Om";										//Ommm
};

//////////////////////////////////////////
instance SVM_8 (C_SVM) // Elite-Garde. Ultra-cool. Pflichtbewusst, ernst, nï¿½chtern! Klare Stimme
{
	StopMagic								= "SVM_8_StopMagic";								//Keine Zaubereien, in meiner Nï¿½he!
	ISaidStopMagic							= "SVM_8_ISaidStopMagic";							//Aufhï¿½ren, sag' ich! Sofort!
	...
	Strange									= "SVM_8_Strange";									//Komm raus! Ich weiï¿½, dass du mich hï¿½rst!
	DieMonster								= "SVM_8_DieMonster";								//Lï¿½stige Viecher!
	DieMortalEnemy							= "SVM_8_DieMortalEnemy";							//Jetzt stirbst du. Nimm's nicht persï¿½nlich!
	...
	YouAskedForIt							= "SVM_8_YouAskedForIt";							//Wer nicht hï¿½ren will, muss fï¿½hlen!
	...
	DirtyThief								= "SVM_8_DirtyThief";								//Das hï¿½ttest du nicht klauen sollen!
	...
	ITakeYourWeapon							= "SVM_8_ITakeYourWeapon";							//Die Waffe gefï¿½llt mir!
	...
	HeKilledHim								= "SVM_8_HeKilledHim";								//Das war unnï¿½tig. du wirst die Folgen zu tragen haben.
	ItWasAGoodFight							= "SVM_8_ItWasAGoodFight";							//War'n guter Kampf!
	Awake									= "SVM_8_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_8_FriendlyGreetings";						//Hallo.
	ALGreetings								= "SVM_8_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_8_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_8_ISaidWhatDoYouWant";						//Kann ich was fï¿½r dich tun?
	MakeWay									= "SVM_8_MakeWay";									//Kann ich da mal vorbei?
	OutOfMyWay								= "SVM_8_OutOfMyWay";								//Geh zur Seite!
	YouDeafOrWhat							= "SVM_8_YouDeafOrWhat";							//Soll ich's in dich reinprï¿½geln? Weg da!
	LookingForTroubleAgain					= "SVM_8_LookingForTroubleAgain";					//Willst du dich noch mal mit mir anlegen?
	LookAway								= "SVM_8_LookAway";									//ï¿½hem ...  ... wirklich schï¿½ne Aussicht!
	OkayKeepIt								= "SVM_8_OkayKeepIt";								//Gut! Es gehï¿½rt dir.
	WhatsThat								= "SVM_8_WhatsThat";								//Hï¿½h? Was war das?
	ThatsMyWeapon							= "SVM_8_ThatsMyWeapon";							//Du trï¿½gst meine Waffe ...?
	...
	SuckerDefeatedNov_Guard					= "SVM_8_SuckerDefeatedNov_Guard";					//Du weiï¿½t, dass die Novizen unter meinem Schutz stehen. Und trotzdem vergreifst du dich an Ihnen?
	...
	YouDefeatedVLK_Guard					= "SVM_8_YouDefeatedVLK_Guard";						//Einen meiner Schï¿½tzlinge anzugreifen kann dich den Kopf kosten.
	YouStoleFromMe							= "SVM_8_YouStoleFromMe";							//Du wagst es mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_8_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	...
	YouKilledGur							= "SVM_8_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_8_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_8_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_8_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_8_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_8_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_8_Smalltalk06";								// ... das war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_8_Smalltalk07";								// ... aber behalt's fï¿½r dich, ich meine, muss ja nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_8_Smalltalk10";								// ... man muss eben aufpassen, was man so rumerzï¿½hlt ...
	Smalltalk11								= "SVM_8_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_8_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_8_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_8_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_8_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_8_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_8_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_8_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_8_Smalltalk22";								// ... erst mal abwarten. Komm, es wird ja auch nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_8_Smalltalk23";								// ... Ah, ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_8_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ....
	Om										= "SVM_8_Om";										//Ommm
};

instance SVM_9 (C_SVM) // brummig gemï¿½tlicher Hï¿½ne, Besonnen, Brummiger Bï¿½r, Einfacher	Mensch
{
	StopMagic								= "SVM_9_StopMagic";								//Ich will keine Magie in meiner Nï¿½he!
	ISaidStopMagic							= "SVM_9_ISaidStopMagic";							//Aufhï¿½ren, sag' ich! Sofort!
	...
	LetsForgetOurLittleFight				= "SVM_9_LetsForgetOurLittleFight";					//Von mir aus kï¿½nnen wir unseren Streit vergessen ...
	Strange									= "SVM_9_Strange";									//Zeig dich. Ich weiï¿½, dass du mich hï¿½rst!
	...
	YouStillNotHaveEnough					= "SVM_9_YouStillNotHaveEnough";					//Du bist verdammt hartnï¿½ckig!
	YouAskedForIt							= "SVM_9_YouAskedForIt";							//Wer nicht hï¿½ren will, muss fï¿½hlen!
	NowWaitIntruder							= "SVM_9_NowWaitIntruder";							//Jetzt mach' ich Hackfleisch aus dir, Eindringling!
	IWillTeachYouRespectForForeignProperty	= "SVM_9_IWillTeachYouRespectForForeignProperty";	//Ich habe dich gewarnt. Wer an meine Sachen geht, kriegt ï¿½rger!
	...
	YoullBeSorryForThis						= "SVM_9_YoullBeSorryForThis";						//Du bist schon tot, du weiï¿½t es nur noch nicht.
	YesYes									= "SVM_9_YesYes";									//Ganz ruhig. Alles in Ordnung!
	ShitWhatAMonster						= "SVM_9_ShitWhatAMonster";							//Scheiï¿½e, was ein Biest!
	Help									= "SVM_9_Help";										//Nichts wie weg!
	WeWillMeetAgain							= "SVM_9_WeWillMeetAgain";							//Man sieht sich immer zweimal.
	NeverTryThatAgain						= "SVM_9_NeverTryThatAgain";						//Beim nï¿½chsten Mal werde ich dich umbringen!
	ITakeYourWeapon							= "SVM_9_ITakeYourWeapon";							//Die Waffe gehï¿½rt jetzt mir!
	...
	WiseMove								= "SVM_9_WiseMove";									//Kluges Kï¿½pfchen!
	...
	YeahWellDone							= "SVM_9_YeahWellDone";								//Souverï¿½n gemeistert, Junge!
	...
	HeKilledHim								= "SVM_9_HeKilledHim";								//Das war unnï¿½tig. du wirst die Folgen zu tragen haben.
	ItWasAGoodFight							= "SVM_9_ItWasAGoodFight";							//War'n guter Kampf!
	Awake									= "SVM_9_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_9_FriendlyGreetings";						//Hallo.
	ALGreetings								= "SVM_9_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_9_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	LookAway								= "SVM_9_LookAway";									//Ach ja! Schï¿½nes Wetter heute!
	OkayKeepIt								= "SVM_9_OkayKeepIt";								//Gut! Es gehï¿½rt dir.
	WhatsThat								= "SVM_9_WhatsThat";								//Was war das denn?
	ThatsMyWeapon							= "SVM_9_ThatsMyWeapon";							//Ich zï¿½hl' bis drei, dann hab' ich meine Waffe wieder.
	...
	SuckerDefeatedVlk_Guard					= "SVM_9_SuckerDefeatedVlk_Guard";					//Was fï¿½llt dir eigentlich ein, einen Buddler zu verkloppen ?
	...
	YouDefeatedVLK_Guard					= "SVM_9_YouDefeatedVLK_Guard";						//Du bist echt zu mutig, einen meiner Schï¿½tzlinge anzufassen, kann dich teuer zu stehen kommen.
	YouStoleFromMe							= "SVM_9_YouStoleFromMe";							//Du wagst es, mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_9_YouStoleFromUs";							//Unsere Leute zu beklauen ist das Letzte! Das wirst du bï¿½ï¿½en!
	...
	YouKilledGur							= "SVM_9_YouKilledGur";								//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_9_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_9_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_9_YouKilledPSIfolk";							//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	...
	Smalltalk06								= "SVM_9_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_9_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht jeder gleich wissen ...
	...
	Smalltalk10								= "SVM_9_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_9_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_9_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_9_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_9_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_9_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_9_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_9_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_9_Smalltalk21";								// ... ja, wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_9_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_9_Smalltalk23";								// ... ich dachte, das wï¿½r' schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_9_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_9_Om";										//Ommm
};

instance SVM_10 (C_SVM) // Schlau, verschlagen, heimlich, Zwielichtig, zynisch, intrigant Dealer (RAVEN, KALOM)
{
	StopMagic								= "SVM_10_StopMagic";								//Hï¿½r mit der Magie auf!
	ISaidStopMagic							= "SVM_10_ISaidStopMagic";							//Hï¿½r sofort damit auf!!!
	...
	WatchYourAim							= "SVM_10_WatchYourAim";							//Nimm das Ding runter, oder ich sorg' selbst dafï¿½r!
	...
	IWillTeachYouRespectForForeignProperty	= "SVM_10_IWillTeachYouRespectForForeignProperty";	//Ich hab' dich gewarnt. Wer an meine Sachen geht, kriegt ï¿½rger!
	...
	YoullBeSorryForThis						= "SVM_10_YoullBeSorryForThis";						//Das wirst du noch zu spï¿½ren kriegen! Bastard!
	YesYes									= "SVM_10_YesYes";									//Ja, Ja! Keine Panik! Hast gewonnen.
	ShitWhatAMonster						= "SVM_10_ShitWhatAMonster";						//Was fï¿½r ein Monstrum, nichts wie weg!
	Help									= "SVM_10_Help";									//Rï¿½ckzug!
	...
	ITakeYourWeapon							= "SVM_10_ITakeYourWeapon";							//Die Waffe gehï¿½rt jetzt mir!
	...
	WiseMove								= "SVM_10_WiseMove";								//Da hast du noch mal Glï¿½ck gehabt.
	...
	RunCoward								= "SVM_10_RunCoward";								//Feigling, komm zurï¿½ck!
	HeDefeatedHim							= "SVM_10_HeDefeatedHim";							//Ein kleiner Windstoï¿½ und er wï¿½re von alleine umgefallen.
	...
	Awake									= "SVM_10_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_10_FriendlyGreetings";						//Hallo.
	ALGreetings								= "SVM_10_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_10_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	YouDeafOrWhat							= "SVM_10_YouDeafOrWhat";							//Soll ich's in dich reinprï¿½geln? Weg da!
	...
	ThatsMyWeapon							= "SVM_10_ThatsMyWeapon";							//Rï¿½ck meine Waffe raus.
	GiveItToMe								= "SVM_10_GiveItToMe";								//Her damit!
	YouCanKeeptheCrap						= "SVM_10_YouCanKeeptheCrap";						//Nimm's dir. Ich brauch' das eh nicht.
	TheyKilledMyFriend						= "SVM_10_TheyKilledMyFriend";						//Sie haben einen unserer Jungs erwischt. Das macht mich verdammt wï¿½tend!
	...
	SuckerDefeatedVlk_Guard					= "SVM_10_SuckerDefeatedVlk_Guard";					//Ich muss hier fï¿½r Ordnung sorgen! Lass meine Leute in Ruhe!
	...
	YouDefeatedVLK_Guard					= "SVM_10_YouDefeatedVLK_Guard";					//Einen meiner Schï¿½tzlinge anzufassen kann dich teuer zu stehen kommen.
	YouStoleFromMe							= "SVM_10_YouStoleFromMe";							//Versuch das nicht noch mal, du Dieb!
	YouStoleFromUs							= "SVM_10_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	...
	YouKilledGur							= "SVM_10_YouKilledGur";							//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_10_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_10_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_10_YouKilledPSIfolk";						//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	...
	Smalltalk06								= "SVM_10_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_10_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_10_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_10_Smalltalk11";								// ... solange ich nichts damit zu tun habe ...
	Smalltalk12								= "SVM_10_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_10_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_10_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_10_Smalltalk18";								// ... ich hï¿½re nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_10_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_10_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_10_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_10_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_10_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_10_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_10_Om";										//Ommm
};

//////////////////////////////////////////
instance SVM_11 (C_SVM) //Profi Ruhig, abgezockt, Vernï¿½nftig aberknallhart
{
	StopMagic								= "SVM_11_StopMagic";								//Keine Zaubereien in meiner Nï¿½he!
	ISaidStopMagic							= "SVM_11_ISaidStopMagic";							//Aufhï¿½ren, sag' ich! Sofort!
	WeaponDown								= "SVM_11_WeaponDown";								//Wenn du Streit suchst, komm ruhig nï¿½her!
	...
	DieMonster								= "SVM_11_DieMonster";								//Die werden aussterben, wenn sie mir stï¿½ndig ï¿½ber den Weg laufen!
	DieMortalEnemy							= "SVM_11_DieMortalEnemy";							//Wer sich Todfeinde macht, muss auch damit umgehen kï¿½nnen, stirb.
	NowWait									= "SVM_11_NowWait";									//Das hï¿½ttest du nicht tun sollen!
	YouStillNotHaveEnough					= "SVM_11_YouStillNotHaveEnough";					//Hab' ich dich nicht schon mal in den Staub getreten? Auf ein Neues ...
	YouAskedForIt							= "SVM_11_YouAskedForIt";							//Wer nicht hï¿½ren will, muss fï¿½hlen!
	...
	YoullBeSorryForThis						= "SVM_11_YoullBeSorryForThis";						//Das hï¿½ttest du besser nicht getan!
	YesYes									= "SVM_11_YesYes";									//Schon gut! Du hast ja gewonnen!
	ShitWhatAMonster						= "SVM_11_ShitWhatAMonster";						//Dieses Vieh ist eine Nummer zu groï¿½ fï¿½r mich!
	Help									= "SVM_11_Help";									//Rï¿½ckzug!
	...
	ITookYourOre							= "SVM_11_ITookYourOre";							//Nett, dass du mir etwas von deinem Erz ï¿½berlï¿½sst!
	...
	WhyAreYouInHere							= "SVM_11_WhyYouAreInHere";							//Die Hï¿½tte gehï¿½rt mir. Raus oder ich ruf die Wachen!
	WhatDidYouInThere						= "SVM_11_WhatDidYouInThere";						//Was wolltest du da drin? Verschwinde, bevor ich mich mit dir beschï¿½ftige!
	...
	CheerFight								= "SVM_11_CheerFight";								//Hï¿½r auf, mit ihm zu spielen!
	...
	HeKilledHim								= "SVM_11_HeKilledHim";								//Du hast ihn getï¿½tet! Das gibt groï¿½en ï¿½rger!
	ItWasAGoodFight							= "SVM_11_ItWasAGoodFight";							//Gut gemacht! Eine saubere Vorstellung!
	Awake									= "SVM_11_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_11_FriendlyGreetings";						//Hallo.
	ALGreetings								= "SVM_11_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_11_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_11_ISaidWhatDoYouWant";						//Kann ich was fï¿½r dich tun?
	MakeWay									= "SVM_11_MakeWay";									//Kann ich da mal vorbei?
	OutOfMyWay								= "SVM_11_OutOfMyWay";								//Geh zur Seite!
	YouDeafOrWhat							= "SVM_11_YouDeafOrWhat";							//Soll ich's in dich reinprï¿½geln? Weg da!
	LookingForTroubleAgain					= "SVM_11_LookingForTroubleAgain";					//Willst du dich noch mal mit mir anlegen?
	LookAway								= "SVM_11_LookAway";								//Man muss sich ja auch nicht ï¿½berall einmischen ...
	OkayKeepIt								= "SVM_11_OkayKeepIt";								//Gut! Es gehï¿½rt dir.
	WhatsThat								= "SVM_11_WhatsThat";								//Was war denn das?
	ThatsMyWeapon							= "SVM_11_ThatsMyWeapon";							//Du trï¿½gst meine Waffe ... ?
	...
	SuckerDefeatedNov_Guard					= "SVM_11_SuckerDefeatedNov_Guard";					//Ich beschï¿½tze die Jungs hier und du hast einen von ihnen umgehauen ...
	...
	YouDefeatedVLK_Guard					= "SVM_11_YouDefeatedVLK_Guard";					//Meine Schï¿½tzlinge anzugreifen kann dich den Kopf kosten.
	YouStoleFromMe							= "SVM_11_YouStoleFromMe";							//Du wagst es, mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_11_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	...
	YouKilledMyFriend						= "SVM_11_YouKilledMyFriend";						//Du hast die Regel Nr.1 gebrochen! Kein Tï¿½ten!
	YouKilledEBr							= "SVM_11_YouKilledEBr";							//Du hast einen Erzbaron umgelegt! Mann, du bist wohl komplett durchgedreht!?
	YouKilledGur							= "SVM_11_YouKilledGur";							//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_11_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_11_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_11_YouKilledPSIfolk";						//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_11_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_11_YouDefeatedMeWell";						//Das war ein guter Kampf. Die Schmerzen werde ich noch tagelang spï¿½ren. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_11_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_11_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_11_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_11_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_11_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_11_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_11_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_11_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_11_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_11_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_11_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_11_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_11_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_11_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_11_Om";										//Ommm
};

instance SVM_12 (C_SVM) //Bazaar-Hï¿½ndler Nach auï¿½en freundlich,jovial,Innen hinterhï¿½ltig, raffgierig
{
	...
	WatchYourAimAngry						= "SVM_12_WatchYourAimAngry";						//Wenn du nicht aufhï¿½rst, gibt's ï¿½rger!
	...
	DieMonster								= "SVM_12_DieMonster";								//Du bist fï¿½llig, Mistvieh!!
	...
	NowWaitIntruder							= "SVM_12_NowWaitIntruder";							//Hier werden sie dich raustragen mï¿½ssen!
	IWillTeachYouRespectForForeignProperty	= "SVM_12_IWillTeachYouRespectForForeignProperty";	//Ich hab' dich gewarnt. Wer an meine Sachen geht, kriegt ï¿½rger!
	...
	ShitWhatAMonster						= "SVM_12_ShitWhatAMonster";						//Das ist 'ne Nummer zu groï¿½! Ich hau ab!
	Help									= "SVM_12_Help";									//Verdammt!
	WeWillMeetAgain							= "SVM_12_WeWillMeetAgain";							//Beim nï¿½chsten Mal sieht die Sache anders aus!
	NeverTryThatAgain						= "SVM_12_NeverTryThatAgain";						//Versuch das nicht noch mal!
	ITakeYourWeapon							= "SVM_12_ITakeYourWeapon";							//Die Waffe gefï¿½llt mir!
	ITookYourOre							= "SVM_12_ITookYourOre";							//Ich sorg dafï¿½r, dass dein Erz gut angelegt wird!
	...
	YouWannaFoolMe							= "SVM_12_YouWannaFoolMe";							//Hï¿½ltst du mich fï¿½r so dï¿½mlich?!
	...
	RunCoward								= "SVM_12_RunCoward";								//Der Typ verdrï¿½ckt sich!
	HeDefeatedHim							= "SVM_12_HeDefeatedHim";							//Klarer Sieger, wï¿½rde ich sagen!
	...
	ItWasAGoodFight							= "SVM_12_ItWasAGoodFight";							//Was fï¿½r ein Kampf!
	Awake									= "SVM_12_Awake";									//Gï¿½ï¿½ï¿½ï¿½hn
	FriendlyGreetings						= "SVM_12_FriendlyGreetings";						//Hallo, Freund!
	ALGreetings								= "SVM_12_ALGreetings";								//Fï¿½r Gomez!
	MageGreetings							= "SVM_12_MageGreetings";							//Magie zu Ehren!
	SectGreetings							= "SVM_12_SectGreetings";							//Erwache!
	ThereHeIs								= "SVM_12_ThereHeIs";								//Da drï¿½ben.
	NoLearnNoPoints							= "SVM_12_NoLearnNoPoints";							//So unerfahren, wie du bist, kann ich dir nichts beibringen.
	NoLearnOverMax							= "SVM_12_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ThatsMyWeapon							= "SVM_12_ThatsMyWeapon";							//Ich wï¿½rde es vorziehen, meine Waffe zurï¿½ckzubekommen!
	...
	SuckerDefeatedVlk_Guard					= "SVM_12_SuckerDefeatedVlk_Guard";					//Was fï¿½llt dir eigentlich ein, einen Buddler zu verkloppen?
	...
	YouDefeatedVLK_Guard					= "SVM_12_YouDefeatedVLK_Guard";					//Du bist echt zu mutig, einen meiner Schï¿½tzlinge anzufassen, kann dich teuer zu stehen kommen.
	YouStoleFromMe							= "SVM_12_YouStoleFromMe";							//Du wagst es mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_12_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	YouStoleFromEBr							= "SVM_12_YouStoleFromEBr";							//Mann! Du hast die Erzbarone beklaut! Die werden toben!
	YouStoleFromGur							= "SVM_12_YouStoleFromGur";							//Du hast die Gurus beklaut! Wenn du dich wenigstens nicht erwischen lassen wï¿½rdest!
	StoleFromMage							= "SVM_12_StoleFromMage";							//Die Magier mï¿½gen es nicht, wenn man in ihren Sachen rumstï¿½bert!
	...
	YouKilledGur							= "SVM_12_YouKilledGur";							//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_12_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	...
	YouKilledPSIfolk						= "SVM_12_YouKilledPSIfolk";						//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer, und wie es scheint, hast du ihn beseitigt!
	GetThingsRight							= "SVM_12_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_12_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_12_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_12_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_12_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_12_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_12_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_12_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_12_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_12_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_12_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_12_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird  ...
	Smalltalk21								= "SVM_12_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_12_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_12_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_12_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_12_Om";										//Ommm
};

instance SVM_13 (C_SVM) // Fanatiker Agressiv, ï¿½bereifrig, ï¿½hnlich wie Stimme7Freak, aber klarer, Ruhm-und-Ehre-Typ, Nov: Glauben an Yï¿½berion blind, Mitlï¿½ufer
{
	...
	WatchYourAimAngry						= "SVM_13_WatchYourAimAngry";						//Du bist auf dem besten Wege zu sterben. Ziel gefï¿½lligst woanders hin!
	...
	NowWait									= "SVM_13_NowWait";									//Das gibt Prï¿½gel ...
	...
	DirtyThief								= "SVM_13_DirtyThief";								//Dreckiger Dieb! Ich werde dir die Hï¿½nde brechen ...
	YouAttackedMyCharge						= "SVM_13_YouAttackedMyCharge";						//Wenn hier jemand Prï¿½gel austeilt, bin ich das!
	...
	NeverTryThatAgain						= "SVM_13_NeverTryThatAgain";						//Beim nï¿½chsten Mal bring ich dich um!
	ITakeYourWeapon							= "SVM_13_ITakeYourWeapon";							//Nette Waffe! Gehï¿½rt die dir? Nein? Okay!
	...
	YouWannaFoolMe							= "SVM_13_YouWannaFoolMe";							//Du versuchst tatsï¿½chlich mich zu verarschen!
	...
	WiseMove								= "SVM_13_WiseMove";								//Dein Glï¿½ck! Aber ich hï¿½tte dir auch gerne die Fresse poliert!
	...
	HeDefeatedHim							= "SVM_13_HeDefeatedHim";							//Kï¿½mmerliche Vorstellung! Ein kleiner Windstoï¿½ und er wï¿½re auch umgefallen.
	HeDeservedIt							= "SVM_13_HeDeservedIt";							//Pah, geschieht ihm recht!
	HeKilledHim								= "SVM_13_HeKilledHim";								//Du bist wirklich lebensmï¿½de, vor Zeugen jemand kalt zu machen.
	ItWasAGoodFight							= "SVM_13_ItWasAGoodFight";							//Netter Kampf!
	Awake									= "SVM_13_Awake";									//Gï¿½ï¿½ï¿½hn!!
	FriendlyGreetings						= "SVM_13_FriendlyGreetings";						//Alles klar bei dir?
	ALGreetings								= "SVM_13_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_13_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	ISaidWhatDoYouWant						= "SVM_13_ISaidWhatDoYouWant";						//Kann ich was fï¿½r dich tun?!
	...
	OkayKeepIt								= "SVM_13_OkayKeepIt";								//Ganz ruhig. Das Teil gehï¿½rt dir.
	WhatsThat								= "SVM_13_WhatsThat";								//Was war denn das?
	ThatsMyWeapon							= "SVM_13_ThatsMyWeapon";							//Gib mir meine Waffe zurï¿½ck!
	GiveItToMe								= "SVM_13_GiveItToMe";								//Her damit!
	YouCanKeeptheCrap						= "SVM_13_YouCanKeeptheCrap";						//Auch gut! Behalt es! Ich finde 'ne andere Lï¿½sung!
	...
	SuckerDefeatedEBr						= "SVM_13_SuckerDefeatedEBr";						//Du hast einen Erzbaron umgehauen. Er ist so richtig wï¿½tend!
	SuckerDefeatedGur						= "SVM_13_SuckerDefeatedGur";						//Du hast einen Guru niedergeschlagen. Irgendwie ziehst du ï¿½rger an!
	SuckerDefeatedMage						= "SVM_13_SuckerDefeatedMage";						//Einen Magier zu besiegen ist 'ne wirklich beschissene Idee!
	SuckerDefeatedNov_Guard					= "SVM_13_SuckerDefeatedNov_Guard";					//Du verprï¿½gelst also die Novizen!
	...
	YouDefeatedNOV_Guard					= "SVM_13_YouDefeatedNOV_Guard";					//Das lï¿½uft nicht, dass du hier Unruhe stiftest!
	YouDefeatedVLK_Guard					= "SVM_13_YouDefeatedVLK_Guard";					//Wenn du jemand verprï¿½gelst, der unter meinem Schutz steht, hat das Konsequenzen!
	...
	YouStoleFromEBr							= "SVM_13_YouStoleFromEBr";							//Du hast die Erzbarone beklaut! Was soll der Scheiï¿½?
	YouStoleFromGur							= "SVM_13_YouStoleFromGur";							//Du hast die Gurus beklaut? Zu blï¿½d, dass es rausgekommen ist!
	...
	YouKilledGur							= "SVM_13_YouKilledGur";							//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_13_YouKilledMage";							//Du hast einen Magier umgebracht! Wie zum Teufel sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_13_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist tot und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_13_YouKilledPSIfolk";						//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_13_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_13_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_13_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_13_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_13_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_13_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_13_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_13_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_13_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_13_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_13_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_13_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_13_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_13_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_13_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_13_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_13_Om";										//Ommm
};

//////////////////////////////////////////
instance SVM_14 (C_SVM) // Xardas(DMB),Corristo,Erzï¿½hler alt arrogant, gebildet
{
	StopMagic								= "SVM_14_StopMagic";								//Steck den Zauber weg!
	ISaidStopMagic							= "SVM_14_ISaidStopMagic";							//Hï¿½rst du nicht, steck den Zauber weg!
	...
	WatchYourAimAngry						= "SVM_14_WatchYourAimAngry";						//Wï¿½rdest du aufhï¿½ren, auf mich zu zielen!
	...
	DieMonster								= "SVM_14_DieMonster";								//Lï¿½stige Kreatur.
	DieMortalEnemy							= "SVM_14_DieMortalEnemy";							//Nimm es nicht persï¿½nlich, dass ich dich tï¿½ten muss!
	NowWait									= "SVM_14_NowWait";									//Das reicht jetzt!
	YouStillNotHaveEnough					= "SVM_14_YouStillNotHaveEnough";					//Du willst doch nicht wieder ï¿½rger?
	YouAskedForIt							= "SVM_14_YouAskedForIt";							//Du wolltest es so haben!
	NowWaitIntruder							= "SVM_14_NowWaitIntruder";							//Du kommst ungebeten!
	IWillTeachYouRespectForForeignProperty	= "SVM_14_IWillTeachYouRespectForForeignProperty";	//Mein Besitz ist nichts fï¿½r dich!
	DirtyThief								= "SVM_14_DirtyThief";								//Du hast dir etwas von mir geliehen! Jetzt musst du auch dafï¿½r bezahlen!
	YouAttackedMyCharge						= "SVM_14_YouAttackedMyCharge";						//Du musst lernen, dich an die Regeln zu halten!
	YouKilledOneOfUs						= "SVM_14_YouKilledOneOfUs";						//Du hast jemanden getï¿½tet!
	...
	ITookYourOre							= "SVM_14_ITookYourOre";							//Das Erz ist sicher nï¿½tzlich!
	...
	HeKilledHim								= "SVM_14_HeKilledHim";								//Ihn umzubringen war unnï¿½tig und wird dir groï¿½e Probleme machen!
	ItWasAGoodFight							= "SVM_14_ItWasAGoodFight";							//Diese Kï¿½mpfe langweilen mich!
	Awake									= "SVM_14_Awake";									//hab' ich etwa geschlafen?
	FriendlyGreetings						= "SVM_14_FriendlyGreetings";						//Sei gegrï¿½ï¿½t.
	ALGreetings								= "SVM_14_ALGreetings";								//Fï¿½r Gomez!
	...
	NoLearnOverMax							= "SVM_14_NoLearnOverMax";							//Du bist am Ende deiner Mï¿½glichkeiten. Du solltest etwas anderes lernen.
	...
	WhatDoYouWant							= "SVM_14_WhatDoYouWant";							//Was kann ich fï¿½r dich tun?
	...
	ThatsMyWeapon							= "SVM_14_ThatsMyWeapon";							//Gib mir meine Waffe zurï¿½ck.
	GiveItToMe								= "SVM_14_GiveItToMe";								//Her damit!
	YouCanKeeptheCrap						= "SVM_14_YouCanKeeptheCrap";						//Schon gut. Ich will es nicht mehr!
	TheyKilledMyFriend						= "SVM_14_TheyKilledMyFriend";						//Einer von uns wurde getï¿½tet. Wir finden den Schuldigen ...
	YouDisturbedMySlumber					= "SVM_14_YouDisturbedMySlumber";					//Du stï¿½rst meine Studien!
	SuckerGotSome							= "SVM_14_SuckerGotSome";							//Du hattest Probleme, hab' ich gehï¿½rt!
	...
	SuckerDefeatedNov_Guard					= "SVM_14_SuckerDefeatedNov_Guard";					//Du weiï¿½t, dass die Novizen unter meinem Schutz stehen. Und trotzdem vergreifst du dich an ihnen?
	...
	YouDefeatedVLK_Guard					= "SVM_14_YouDefeatedVLK_Guard";					//Einen meiner Schï¿½tzlinge anzugreifen kann dich den Kopf kosten.
	YouStoleFromMe							= "SVM_14_YouStoleFromMe";							//Du wagst es mir unter die Augen zu treten, dreckiger Dieb?
	YouStoleFromUs							= "SVM_14_YouStoleFromUs";							//Du hast einige Sachen, die uns gehï¿½ren. Gib sie besser wieder her.
	...
	YouKilledGur							= "SVM_14_YouKilledGur";							//Du hast einen Guru getï¿½tet! Junge, das kann doch nicht wahr sein!
	YouKilledMage							= "SVM_14_YouKilledMage";							//Du hast einen Magier umgebracht! Wie sollen wir das denn erklï¿½ren?
	YouKilledOCfolk							= "SVM_14_YouKilledOCfolk";							//Jemand aus dem Alten Lager ist verstorben und dein Name wird dabei erwï¿½hnt ...
	...
	YouKilledPSIfolk						= "SVM_14_YouKilledPSIfolk";						//Die Bruderschaft ist um einen Anhï¿½nger ï¿½rmer und wie es scheint, warst du das!
	GetThingsRight							= "SVM_14_GetThingsRight";							//Das wieder hinzubiegen wird nicht einfach!
	YouDefeatedMeWell						= "SVM_14_YouDefeatedMeWell";						//Du hast mir ganz schï¿½n aufs Maul gehauen, Mann. War ein guter Kampf. Aber jetzt ist gut!
	...
	Smalltalk06								= "SVM_14_Smalltalk06";								// ... war doch klar, dass das ï¿½rger gibt ...
	Smalltalk07								= "SVM_14_Smalltalk07";								// ... aber behalt's fï¿½r dich, muss ja nicht gleich jeder wissen ...
	...
	Smalltalk10								= "SVM_14_Smalltalk10";								// ... man muss eben aufpassen, was man rumerzï¿½hlt ...
	Smalltalk11								= "SVM_14_Smalltalk11";								// ... solange ich damit nichts zu tun habe ...
	Smalltalk12								= "SVM_14_Smalltalk12";								// ... man darf auch nicht alles glauben, was man hï¿½rt ...
	...
	Smalltalk16								= "SVM_14_Smalltalk16";								// ... frï¿½her wï¿½re das ganz anders gelaufen ...
	Smalltalk17								= "SVM_14_Smalltalk17";								// ... gequatscht wird viel ...
	Smalltalk18								= "SVM_14_Smalltalk18";								// ... ich hï¿½r' nicht mehr auf das Gefasel ...
	Smalltalk19								= "SVM_14_Smalltalk19";								// ... verlass dich auf jemanden und du bist verlassen, das ist eben so ...
	Smalltalk20								= "SVM_14_Smalltalk20";								// ... ich glaube kaum, dass sich daran was ï¿½ndern wird ...
	Smalltalk21								= "SVM_14_Smalltalk21";								// ... wahrscheinlich hast du Recht ...
	Smalltalk22								= "SVM_14_Smalltalk22";								// ... erst mal abwarten. Es wird nichts so heiï¿½ gegessen, wie es gekocht wird ...
	Smalltalk23								= "SVM_14_Smalltalk23";								// ... ich dachte, das wï¿½re schon lange geklï¿½rt ...
	Smalltalk24								= "SVM_14_Smalltalk24";								// ... lass uns lieber ï¿½ber was anderes reden ...
	Om										= "SVM_14_Om";										//Ommm
};
...
INSTANCE SVM_15 (C_SVM) // PLAYER trocken,ernst
{
	...
	ALGreetings								= "SVM_15_ALGreetings";								//Fï¿½r Gomez!
	MageGreetings							= "SVM_15_MageGreetings";							//Sei gegrï¿½ï¿½t!
	...
	NeedKey									= "SVM_15_NeedKey";									//Dafï¿½r brauch' ich den Schlï¿½ssel ...
...
//////////////////////////////////////////
INSTANCE SVM_17 (C_SVM)							//Ork-Stimme (alle SVMs werden auf wenige guturalen, unverstï¿½ndlichen Laute umgeleitet)
												//Die Dialoge mit dem verbannten Ork-Shamanen im Kastell und dem Ork-Sklaven in der Freien Mine laufen auch
												//ï¿½ber Stimme 17, sind aber in halbwegsverstï¿½ndlichem orkisch-deutsch
												//Das hier ï¿½berall vergebene SVM_17_OrcSound01 wird noch durch 9 weitere Variationen ergï¿½nzt
